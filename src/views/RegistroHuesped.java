...
public class RegistroHuesped extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					RegistroHuesped frame = new RegistroHuesped(id_reserva);
	...
	public RegistroHuesped(Integer id_reserva) {
		...
		txtNreserva.setText(id_reserva.toString());
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    public void guardarHuesped() {
	    	...
	    	try {
	    		String fecha_nac = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		    	Huesped huesped = new Huesped(txtNombre.getText(),txtApellido.getText(),java.sql.Date.valueOf(fecha_nac),txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(),Integer.valueOf(txtNreserva.getText()));
		    	System.out.println("Nombre: " + huesped.getNombre() +
		    					   "Apellido: " + huesped.getApellido() +
		    					   "Fecha: " + huesped.getFechaNac() +
		    					   "Nac: " + huesped.getNacionalidad() +
		    					   "tel: " + huesped.getTelefono() +
		    					   "idres: " + huesped.getIdReserva());
